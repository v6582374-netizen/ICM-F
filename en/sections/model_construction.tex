...
\caption{Three-dimensional heterogeneity cloud of all occupations with the optimal triangle (strict mapping, globally normalized).}
...
\caption{Two-dimensional projections of all occupations with the optimal triangle highlighted (strict mapping, globally normalized).}
